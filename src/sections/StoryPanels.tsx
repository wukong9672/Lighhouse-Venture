...
export const StoryPanels = () => (
  <div id="top">
    <section className="story-panel relative z-10 flex min-h-screen items-center justify-center overflow-hidden bg-pitchBlack px-6">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.07)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.07)_1px,transparent_1px)] bg-[size:44px_44px] opacity-20" />
    ...
    >
      <div className="w-full max-w-3xl text-center">
        ...
        <motion.a
          className="inline-flex w-full justify-center bg-white px-8 py-7 text-sm font-black uppercase tracking-[0.32em] text-black transition-colors duration-500 hover:bg-burntOrange hover:text-black"
